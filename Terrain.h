////***************************************************************************************
//// CTerrain.h by Frank Luna (C) 2011 All Rights Reserved.
////   
...
//	void SetTerrainVertices(std::vector <Vertex::Terrain>& value);
//	std::vector<Vertex::Terrain> GetTerrainVertices();
//
...
//	std::vector<Vertex::Terrain> TerrainVertices;
//
//private:
//
