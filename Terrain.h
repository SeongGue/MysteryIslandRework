...
public:
	...
	void SetTerrainVertices(vector <Vertex::Terrain>& value);
	vector<Vertex::Terrain> GetTerrainVertices();
	...
	void Draw(ID3D11DeviceContext* dc, const Camera& cam, DirectionalLight lights[3], PointLight pointLight, XMFLOAT4X4 shadowTransform, int terrainType);
...
private:
	...
	vector<Vertex::Terrain> TerrainVertices;
