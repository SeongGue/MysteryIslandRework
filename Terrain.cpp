...
//}
//
//void CTerrain::SetTerrainVertices(std::vector<Vertex::Terrain>& value)
//{
//
//	TerrainVertices = value;
//}
//
//std::vector<Vertex::Terrain> CTerrain::GetTerrainVertices()
//{
...
//}
//
//void CTerrain::Draw(ID3D11DeviceContext* dc)
//{
//	dc->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_4_CONTROL_POINT_PATCHLIST);
//	dc->IASetInputLayout(InputLayouts::CTerrain);
//
//	UINT stride = sizeof(Vertex::CTerrain);
//	UINT offset = 0;
...
//	Effects::TerrainFX->SetTerrainType(terrainType);
//
...
//	Effects::TerrainFX->SetShadowTransform(world * XMLoadFloat4x4(&shadowTransform));
//
...
//{
//	std::vector<Vertex::CTerrain> patchVertices(mNumPatchVertRows*mNumPatchVertCols);
//
...
//	}
//
//	SetTerrainVertices(patchVertices);
//
//	D3D11_BUFFER_DESC vbd;
//	vbd.Usage = D3D11_USAGE_IMMUTABLE;
//	vbd.ByteWidth = sizeof(Vertex::CTerrain) * patchVertices.size();
